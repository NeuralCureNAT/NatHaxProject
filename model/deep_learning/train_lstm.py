"""
LSTM Model Training for EEG Migraine Severity Prediction
Long Short-Term Memory Network for Temporal Sequence Learning
...
def train_lstm_model(X_sequences, y_sequences, sequence_length, epochs=100, batch_size=128):
    """Train LSTM model"""
    print("\n" + "="*70)
    ...
    print("="*60)
    print("Architecture: LSTM → LSTM → LSTM → Dense")
    print("Expected: Good for temporal pattern recognition and sequence learning")
    ...
    lstm_model.model.compile(optimizer=optimizer, loss='mse', metrics=['mae'])
    ...
    return lstm_model, history, {'r2': r2, 'rmse': rmse, 'mae': mae, 'training_time': training_time}

def save_model(model, processor, filepath_prefix='eeg_lstm'):
...
def main():
    ...
    print("="*70)
    print("\nLong Short-Term Memory Network for EEG Migraine Severity Prediction")
    ...
    # Train model
    model, history, results = train_lstm_model(
